...
const EditFormSeven = ({selectedGunha, gunhaId, onClose }) => {
  ...
  useEffect(() => {
    const fetchGunhaData = async () => {
      try {
        ...
        setFormData({
          jalitDdakhalKarnaryacheNav: gunhaData.jalitDdakhalKarnaryacheNav || '',
          jalitZalyachaDateTime: gunhaData.jalitZalyachaDateTime || '',
          jalitDakhalKelyachaDateTime: gunhaData.jalitDakhalKelyachaDateTime || '',
          jalitGhadlyachaeThikanDishaPoliceStation: gunhaData.jalitGhadlyachaeThikanDishaPoliceStation || '',
          khabarDenaryacheSampurnNavAniPatta: gunhaData.khabarDenaryacheSampurnNavAniPatta || '',
          hakikat: gunhaData.hakikat || '',
          jalitatZaleleNuksan: gunhaData.jalitatZaleleNuksan || '',
          jalitamadheHaniZaliAaslyas: gunhaData.jalitamadheHaniZaliAaslyas || '',
          gunhyachaPrakar: gunhaData.gunhyachaPrakar || '',
          tapasKonakade: gunhaData.tapasKonakade || '',
          mamledarReport: gunhaData.mamledarReport || '',
          date: gunhaData.date || '',
          reportPathvilela: gunhaData.reportPathvilela || '',
